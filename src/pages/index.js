      ...
      <main className='flex items-center text-dark w-full min-h-screen dark:text-light'>
        <Layout>
          <div className="flex items-center justify-between w-full">
            <div className='w-1/3'>
              <Image src={profilePic} alt='Luke Haskell' className='w-full h-auto rounded-full' />
            </div>
            <div className='w-3/5'>
              <AnimatedText text='Turning Vision Into Reality With Code & Design' className='!text-6xl text-right' />
